...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const titles = {
    en: "Introducing ImageFlux: Transform Your Images with AI | ImageFlux Blog",
    zh: "ImageFlux介绍：用AI的力量改变你的图像 | ImageFlux 博客"
  }
  
  const descriptions = {
    en: "Discover ImageFlux, the revolutionary AI-powered image transformation platform. Edit and transform images using simple text prompts with cutting-edge AI technology.",
    zh: "发现ImageFlux，革命性的AI驱动图像转换平台。使用尖端AI技术，通过简单的文本提示编辑和转换图像。"
  }
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://imageflux.tools/${locale}/blog/introducing-imageflux`,
      siteName: "ImageFlux",
      locale: locale === 'zh' ? 'zh_CN' : 'en_US',
      type: 'article',
      images: [
        {
          url: 'https://imageflux.tools/images/Transform Your Images with the Power of AI.png',
          width: 1000,
          height: 500,
          alt: 'ImageFlux Introduction',
        },
      ],
    },
    twitter: {
      ...
      title,
      description,
      images: ['https://imageflux.tools/images/Transform Your Images with the Power of AI.png'],
    },
    alternates: {
      canonical: `https://imageflux.tools/${locale}/blog/introducing-imageflux`,
      languages: {
        'en': 'https://imageflux.tools/en/blog/introducing-imageflux',
        'zh': 'https://imageflux.tools/zh/blog/introducing-imageflux',
      },
    },
  }
}
...
export default async function IntroducingImageflux({ params }: BlogPostProps) {
  const { locale } = await params
  const t = (key: string) => {
    const translations: Record<string, Record<string, string>> = {
      en: {
        ...
        title: "Introducing ImageFlux: Transform Your Images with the Power of AI",
        publishDate: "May 31, 2025",
        readTime: "5 min read",
        category: "Product",
        introduction: "Introduction",
        introText:
          "Today, we're excited to introduce ImageFlux, a revolutionary AI-powered image transformation platform that allows you to edit and transform your images using simple text prompts. Whether you're a professional designer, a social media manager, or just someone who loves creating beautiful images, ImageFlux makes image editing accessible, fun, and incredibly powerful.",
        whatIsImageFlux: "What is ImageFlux?",
        whatIsText:
          "ImageFlux is an AI-powered image editing platform that understands natural language. Instead of learning complex editing software or manipulating dozens of sliders and controls, you simply describe what you want to change about your image, and our AI does the rest. Want to turn a daytime photo into a night scene? Add a cat to your living room photo? Transform your portrait into an anime character? With ImageFlux, it's as simple as typing your request.",
        ...
        howItWorksText: "Using ImageFlux is incredibly simple:",
        ...
        useCases: "Use Cases",
        useCasesText: "ImageFlux can be used in countless creative ways:",
        ...
        gettingStartedText: "Ready to transform your images with ImageFlux? Getting started is easy:",
        ...
        conclusionText:
          "ImageFlux represents the future of image editing – where complex technical skills are replaced by simple, natural language instructions. We're just getting started, and we have an exciting roadmap of new features and capabilities planned for the coming months.",
        conclusionText2:
        ...
        tryItNow: "Try ImageFlux Now",
      },
      zh: {
        backToHome: "返回首页",
        backToBlog: "返回博客",
        title: "ImageFlux介绍：用AI的力量改变你的图像",
        publishDate: "2025年5月31日",
        readTime: "5分钟阅读",
        category: "产品",
        introduction: "介绍",
        introText:
          "今天，我们很高兴地介绍ImageFlux，这是一个革命性的AI驱动图像转换平台，允许您使用简单的文本提示编辑和转换图像。无论您是专业设计师、社交媒体经理，还是只是喜欢创建美丽图像的人，ImageFlux都使图像编辑变得易于使用、有趣且功能强大。",
        whatIsImageFlux: "什么是ImageFlux？",
        whatIsText:
          "ImageFlux是一个能够理解自然语言的AI驱动图像编辑平台。您无需学习复杂的编辑软件或操作数十个滑块和控件，只需描述您想要对图像进行的更改，我们的AI就会完成其余的工作。想要将白天的照片变成夜景？在您的客厅照片中添加一只猫？将您的肖像转变为动漫角色？使用ImageFlux，只需输入您的请求即可。",
        keyFeatures: "主要功能",
        ...
        howItWorks: "工作原理",
        howItWorksText: "使用ImageFlux非常简单：",
        step1: "1. 上传您的图像",
        ...
        useCases: "使用场景",
        useCasesText: "ImageFlux可以在无数创意方式中使用：",
        useCase1: "• 社交媒体内容创作",
        ...
        gettingStarted: "入门指南",
        gettingStartedText: "准备好用ImageFlux转换您的图像了吗？入门很简单：",
        ...
        conclusion: "结论",
        conclusionText:
          "ImageFlux代表了图像编辑的未来——复杂的技术技能被简单、自然的语言指令所取代。我们才刚刚开始，我们计划在未来几个月内推出令人兴奋的新功能和能力。",
        conclusionText2:
          "我们邀请您加入我们的旅程，体验AI驱动的图像转换的魔力。立即注册并开始创建仅受您想象力限制的图像。",
        tryItNow: "立即试用ImageFlux",
      },
    }
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
                ...
                <section>
                  <h2 className="text-2xl font-semibold mb-4">{t("whatIsImageFlux")}</h2>
